...
const pendingDocuments = ref<PendingDocument[]>([
  {
    id: '1',
    title: '关于加强城镇基层治理的通知',
    docNumber: 'QZFWJ-2023-045',
    type: '通知',
    urgency: '急',
    sender: '张明',
    department: '政府办公室',
    createTime: '2023-05-15 09:30:45',
    deadline: '2023-05-18',
    status: '待审批'
  },
  {
    id: '2',
    title: '2023年度农村人居环境整治工作计划',
    docNumber: 'QZFWJ-2023-046',
    type: '计划',
    urgency: '特急',
    sender: '李强',
    department: '农业农村办公室',
    createTime: '2023-05-16 10:15:22',
    deadline: '2023-05-19',
    status: '待审批'
  },
  {
    id: '3',
    title: '关于开展防汛安全检查的通知',
    docNumber: 'QZFWJ-2023-047',
    type: '通知',
    urgency: '平件',
    sender: '王佳',
    department: '应急管理办公室',
    createTime: '2023-05-16 14:05:37',
    deadline: '2023-05-23',
    status: '待处理'
  },
  {
    id: '10',
    title: '关于开展城前镇2023年度安全生产月活动的通知',
    docNumber: 'QZFWJ-2023-056',
    type: '通知',
    urgency: '急',
    sender: '周琦',
    department: '安全生产委员会',
    createTime: '2023-05-17 08:22:15',
    deadline: '2023-05-20',
    status: '待审批'
  },
  {
    ...
    docNumber: 'QZFWJ-2023-057',
    type: '方案',
    urgency: '特急',
    sender: '赵敏',
    department: '城建办公室',
    createTime: '2023-05-17 09:10:45',
    deadline: '2023-05-21',
    status: '待审批'
  },
  {
    id: '12',
    title: '关于统计上报2023年第二季度财政收支情况的通知',
    docNumber: 'QZFWJ-2023-058',
    type: '通知',
    urgency: '平件',
    sender: '钱华',
    department: '财政所',
    createTime: '2023-05-17 11:30:22',
    deadline: '2023-05-25',
    status: '待处理'
  }
])
...
const processedDocuments = ref<ProcessedDocument[]>([
  {
    ...
    docNumber: 'QZFWJ-2023-042',
    type: '通知',
    urgency: '急',
    sender: '张明',
    department: '安监办',
    createTime: '2023-05-10 11:22:33',
    processTime: '2023-05-12 09:45:12',
    status: '已审批',
    result: '同意'
  },
  {
    id: '5',
    title: '2023年第二季度财政预算执行情况报告',
    docNumber: 'QZFWJ-2023-043',
    type: '报告',
    urgency: '平件',
    sender: '赵敏',
    department: '财政所',
    createTime: '2023-05-08 16:30:25',
    processTime: '2023-05-11 14:18:05',
    status: '已审批',
    result: '同意'
  },
  {
    ...
    docNumber: 'QZFWJ-2023-044',
    type: '请示',
    urgency: '急',
    sender: '刘畅',
    department: '民政所',
    createTime: '2023-05-09 09:15:40',
    processTime: '2023-05-12 16:40:22',
    status: '已审批',
    result: '同意并附建议'
  },
  {
    ...
    docNumber: 'QZFWJ-2023-038',
    type: '报告',
    urgency: '平件',
    sender: '孙磊',
    department: '城建办公室',
    createTime: '2023-05-05 08:40:25',
    processTime: '2023-05-08 10:12:30',
    status: '已审批',
    result: '同意'
  },
  {
    id: '14',
    title: '关于申请2023年度农村饮水安全工程专项资金的请示',
    docNumber: 'QZFWJ-2023-039',
    type: '请示',
    urgency: '急',
    sender: '杨帆',
    department: '水务局',
    createTime: '2023-05-06 10:20:18',
    processTime: '2023-05-09 15:33:45',
    status: '已审批',
    result: '同意'
  },
  {
    ...
    docNumber: 'QZFWJ-2023-040',
    type: '意见',
    urgency: '平件',
    sender: '胡敏',
    department: '文化旅游局',
    createTime: '2023-05-07 14:25:32',
    processTime: '2023-05-10 11:05:18',
    status: '已退回',
    result: '需要修改后重新提交'
  },
  {
    id: '16',
    title: '城前镇2023年度政府信息公开工作要点',
    docNumber: 'QZFWJ-2023-041',
    type: '通知',
    urgency: '平件',
    sender: '郭静',
    department: '政府办公室',
    createTime: '2023-05-08 09:18:40',
    processTime: '2023-05-10 16:22:50',
    status: '已审批',
    result: '同意并要求尽快落实'
  }
])
...
const createdDocuments = ref<CreatedDocument[]>([
  {
    ...
    docNumber: 'QZFWJ-2023-048',
    type: '请示',
    urgency: '急',
    receiver: '镇政府办',
    createTime: '2023-05-17 08:45:12',
    status: '流转中',
    currentHandler: '王镇长',
  ...
  },
  {
    ...
    docNumber: 'QZFWJ-2023-049',
    type: '报告',
    urgency: '平件',
    receiver: '财政所',
    createTime: '2023-05-17 11:30:45',
    status: '流转中',
    currentHandler: '李所长',
  ...
  },
  {
    ...
    docNumber: 'QZFWJ-2023-050',
    type: '意见',
    urgency: '平件',
    receiver: '农业农村办公室',
    createTime: '2023-05-16 09:20:15',
    status: '流转中',
    currentHandler: '陈主任',
  ...
  },
  {
    ...
    docNumber: 'QZFWJ-2023-051',
    type: '请示',
    urgency: '急',
    receiver: '财政所',
    createTime: '2023-05-16 11:05:30',
    status: '已完成',
    currentHandler: '已办结',
    currentDepartment: '财政所'
  },
  {
    id: '19',
    title: '关于组织开展2023年度农村低保评审工作的请示',
    docNumber: 'QZFWJ-2023-052',
    type: '请示',
    urgency: '平件',
    receiver: '民政所',
    createTime: '2023-05-15 14:22:38',
    status: '已退回',
    currentHandler: '张所长',
  ...
  {
    id: '20',
    title: '城前镇2023年度基础教育质量提升计划',
    docNumber: 'QZFWJ-2023-053',
    type: '计划',
    urgency: '平件',
    receiver: '教育科',
    createTime: '2023-05-15 16:40:20',
    status: '已完成',
    currentHandler: '已办结',
